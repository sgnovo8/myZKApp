...
export class AgeVerifier extends SmartContract {
  ...
  //function that basically creates a ZK proof, includes the restraint that says
  ...
  @method verifyAge(userAge: Field, ageLimitUpdate: Field) {
    ...
    //on chain by using the gtter and then we're going to say "currentAgeLimit" on chain
